                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class='input-group'>
                                <input type='text' required="required" id='item-name' name="item-name"
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <input type="submit" value="Update" class="btn btn-primary" id="myBtn"/>
                        </div>
                    </div>
                </div>
            </div>
    ...
    btn.addEventListener('click', function() {
        ...
        if(itemName && price && qty) {
            $.ajax({
                url: 'add_item.php',
                type: 'POST',
                data: {data: {itemCode:itemCode, name: itemName, qty: qty, price: price}, type:type},
                success: function (data) {
                    alert('Item Updated Siccessfully');
